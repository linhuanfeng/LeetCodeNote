...
public class BufferStreamTest {
    public static void main(String[] args) throws IOException {
        FileInputStream stream = new FileInputStream("F:\\java_install\\java_projects\\leetcode\\测试\\src\\java基础\\io\\cn.txt");
        BufferedInputStream bs = new BufferedInputStream(stream);
        byte[] bytes = new byte[10];
        int read = bs.read(bytes);
        System.out.println(new String(bytes));

        String path="F:\\java_install\\java_projects\\leetcode\\测试\\src\\java基础\\io\\字节流\\vedio.txt";
        String path2="F:\\java_install\\java_projects\\leetcode\\测试\\src\\java基础\\io\\字节流\\vedio-copy.txt";
