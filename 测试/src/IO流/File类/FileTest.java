...
public class FileTest {
    public static void main(String[] args) {
        String pathName="F:\\java_install\\java_projects\\leetcode\\测试\\src\\构造方法测试\\java基础\\Variable.java";
        File file = new File(pathName);
        System.out.println(file); // F:\java_install\java_projects\leetcode\测试\src\构造方法测试\java基础\Variable.java
        ...
        System.out.println(file.getParent());      // F:\java_install\java_projects\leetcode\测试\src\构造方法测试\java基础
        System.out.println(file.getParentFile());  // F:\java_install\java_projects\leetcode\测试\src\构造方法测试\java基础
        // 获取长度、
...
//            System.out.print(s+" ");
//        }
        File file2 = new File("F:\\java_install\\java_projects\\leetcode\\测试\\src\\构造方法测试\\java基础");
        ...
        System.out.println(file2); // F:\java_install\java_projects\leetcode\测试\src\构造方法测试\java基础\Variable.java
...
//        System.out.println(delete); // 存在则删除并返回true
        ...
        File file6 = new File("F:\\java_install\\java_projects\\leetcode\\测试\\src\\构造方法测试");
        ...
        for (File file1 : files) {
            System.out.print(file1+" "); // F:\java_install\java_projects\leetcode\测试\src\构造方法测试\java基础 F:\java_install\java_projects\leetcode\测试\src\构造方法测试\父子类加载顺序
        }
        System.out.println();
//        Arrays
//        Map
